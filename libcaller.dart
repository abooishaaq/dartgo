// something like this should be generated by gogen
...
void main() {
  ...
  var libraryPath = './lib.so';
  final dylib = ffi.DynamicLibrary.open(libraryPath);

  // Look up the "NewPoint" function
  final NewPoint newPoint = dylib
      .lookup<ffi.NativeFunction<new_point_func>>('Wrap__F_new_point')
      .asFunction();
  final AddPoint addPoint = dylib
      .lookup<ffi.NativeFunction<add_point_func>>('Wrap__F_add_point')
      .asFunction();
  final MutatePoint mutatePoint = dylib
      .lookup<ffi.NativeFunction<mutate_point_func>>('Wrap__F_mutate_point')
      .asFunction();
